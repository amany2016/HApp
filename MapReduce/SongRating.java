package Music;
 ...
 /**
 * The Goal of this program is to find the average rating of a song by the different users.
 */
...
public class SongRating extends Configured implements Tool {

    public static void execute(String[] args){
        int res = 0;
        try {
            res = ToolRunner.run(new SongRating(), args);
        } catch (Exception e) {
            e.printStackTrace();
        }
        System.exit(res);
    ...
    String maxKey = null;
      ...
      public void map(LongWritable offset, Text lineText, Context context)
        ...
        if(data.length > 2){
          ...
          // Send the <Song-Id, Rating> to the reducer
