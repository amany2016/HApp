package Music;
 ...
 /**
 * The Goal of this program is to find the average rating of an artist based on the songs he had sung.
 */
...
public class ArtistRating extends Configured implements Tool {

    public static void execute(String[] args){
        int res = 0;
        try {
            res = ToolRunner.run(new ArtistRating(), args);
        } catch (Exception e) {
            e.printStackTrace();
        }
        System.exit(res);
  ...
  public int run(String[] args) throws Exception {
    Job job = Job.getInstance(getConf(), "ArtistRating");
    ...
    String maxKey = null;
      ...
      public void map(LongWritable offset, Text lineText, Context context)
        ...
        if(data.length > 2){
          ...
          // Send the <Artist-Id, Rating> to the reducer
